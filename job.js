...
let currentData = [];
  ...
  function searchJobs() {
    ...
    const apiUrl = `http://api.adzuna.com:80/v1/api/jobs/${country.toLowerCase()}/search/1?app_id=e21e0eae&app_key=6961fcc6610bef298f086af6e90af991&results_per_page=20&what=${encodeURIComponent(jobKeyword)}&where=${encodeURIComponent(city)}&content-type=application/json`;
